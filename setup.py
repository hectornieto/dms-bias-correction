#!/usr/bin/env python
#
# This file is part of dms-bias-correction.
...
SHORT_DESCRIPTION = "Helper tools to preprocess satellite data for running TSEB"
reqs = ["numpy", "matplotlib", "scipy", "scikit-image", "pyDMS", "gdal"]

setup(
    name                  = "dms_bias_correction",
    packages              = ['dms_bias_correction'],
